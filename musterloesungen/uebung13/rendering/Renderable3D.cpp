...
void Renderable3D::setPosition(const Vector3f& pos)
{
	m_position = pos;
}
...
const Vector3f& Renderable3D::xAxis() const
{
	return m_xAxis;
}

const Vector3f& Renderable3D::yAxis() const
{
	return m_yAxis;
}

const Vector3f& Renderable3D::zAxis() const
{
	return m_zAxis;
}

const Vector3f& Renderable3D::position() const
{
	return m_position;
}
