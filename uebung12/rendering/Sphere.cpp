...
namespace asteroids {
    ...
    void Sphere::render() {
        ...
        for (curStack = 0; curStack < m_numStacks - 2; curStack++) {
            ...
            for (curSlice = 0; curSlice < m_numSides; curSlice++) {
                glNormal3d(points[vertIndex + curSlice][0], points[vertIndex + curSlice][1],
                           points[vertIndex + curSlice][2]);
                glVertex3d(points[vertIndex + curSlice][0], points[vertIndex + curSlice][1],
                           points[vertIndex + curSlice][2]);

                glNormal3d(points[vertIndex + m_numSides + curSlice][0], points[vertIndex + m_numSides + curSlice][1],
                           points[vertIndex + m_numSides + curSlice][2]);
                glVertex3d(points[vertIndex + m_numSides + curSlice][0], points[vertIndex + m_numSides + curSlice][1],
                           points[vertIndex + m_numSides + curSlice][2]);
            }
            ...
            glNormal3d(points[vertIndex + m_numSides][0], points[vertIndex + m_numSides][1],
                       points[vertIndex + m_numSides][2]);
            glVertex3d(points[vertIndex + m_numSides][0], points[vertIndex + m_numSides][1],
                       points[vertIndex + m_numSides][2]);
            glEnd();
        }
