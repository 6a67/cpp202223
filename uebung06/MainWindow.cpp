...
: m_camera(Vector(0.0f, 0.0f, -700.0f), 0.05f, 5.0f)
{
    ...
    // Setup window
    m_sdlWindow = SDL_CreateWindow("SDL Main Window",
    ...
    if (m_model && m_sdlWindow && m_sdlGlcontext)
    {
        ...
        while (loop)
        {
            ...
            while (SDL_PollEvent(&event))
            {
                ...
                {
                    m_model->rotate(Model::PITCH, 0.05);
                }
